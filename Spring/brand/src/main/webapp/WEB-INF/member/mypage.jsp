    ...
    <div class="member">
      <div>
        <section class="register">
          <form action="/brand/member/mypage.do" method="post">
            <section>
              <table>
                <tr>
                  <th>아이디</th>
                  <td>
                    <input type="text" name="uid" value="${ member.bm_uid }" placeholder="아이디 입력" required />
            ...
            <section>
              <table>
                <tr>
                  <th>이름</th>
                  <td><input type="text" name="name" value="${ member.bm_name }" placeholder="이름 입력" required /></td>
                </tr>
                <tr>
                  <th>성별</th>
                  <td>
            ...
            <div>
              <input type="submit" class="join" value="수정하기" />
            </div>
          </form>
        </section>
    </div>
