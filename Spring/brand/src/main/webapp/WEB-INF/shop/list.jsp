...
<%@ include file="../header.jsp" %>
    ...
    <div class="subpage">
      ...
      <div>
        ...
        <section class="list">
            <ul class="sort">
              <li><a href="/brand/shop/listOrder.do?order=sales&cat=${ cat }">인기순</a></li>
              <li><a href="#">&nbsp|&nbsp</a></li>
              <li><a href="/brand/shop/listOrder.do?order=new&cat=${ cat }">신상품순</a></li>
              <li><a href="#">&nbsp|&nbsp</a></li>
              <li><a href="/brand/shop/listOrder.do?order=price_desc&cat=${ cat }">높은 가격순</a></li>
              <li><a href="#">&nbsp|&nbsp</a></li>
              <li><a href="/brand/shop/listOrder.do?order=price_asc&cat=${ cat }">낮은 가격순</a></li>
            </ul>
